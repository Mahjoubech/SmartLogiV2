...
public class ColisController {
    ...
    @PreAuthorize("hasAnyRole('MANAGER' , 'CLIENT') and hasAuthority('VIEW')")
    @GetMapping("/{colisId}")
    ...
    @PreAuthorize("hasRole('CLIENT') and hasAuthority('UPDATE')")
    @PutMapping("/{colisId}")
    ...
    @PreAuthorize("hasRole('CLIENT') and hasAuthority('DELETE')")
    ...
    @PreAuthorize("hasAnyRole('LIVREUR' , 'MANAGER') and hasAuthority('UPDATE')")
    ...
    @PreAuthorize("hasAnyRole('MANAGER') and hasAuthority('ASSIGN')")
    ...
    @PreAuthorize("hasAnyRole('MANAGER' , 'LIVREUR') and hasAuthority('VIEW')")
    @GetMapping("/search")
    ...
    @PreAuthorize("hasRole('CLIENT') and hasAuthority('VIEW')")
    ...
    @PreAuthorize("hasAnyRole('MANAGER' , 'CLIENT' , 'LIVREUR') and hasAuthority('VIEW')")
